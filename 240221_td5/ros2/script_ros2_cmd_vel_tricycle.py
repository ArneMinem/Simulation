...
# This is a simple example of a ROS2-enabled CoppeliaSim scene.
# It requires a CoppeliaSim scene that has a Tricycle model, with a proximity sensor, a steering joint and a motor joint.
# The scene should also have a ROS2 interface (e.g. a ROS2Interface child script) that is associated with the proximity sensor and the two joints.
